...
- (void)setupVAOs {
    ...
    glVertexAttribPointer(aPosition, 3, GL_FLOAT, GL_FALSE, sizeof(GLfloat) * 3, 0);
    ...
    glVertexAttribPointer(aTexCoord, 3, GL_FLOAT, GL_FALSE, sizeof(GLfloat) * 2, 0);
...
void renderImage() {
    ...
    glBindTexture(GL_TEXTURE_2D, fbo_->getFboTexture());
